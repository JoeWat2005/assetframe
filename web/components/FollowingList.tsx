  ...
  if (items.length === 0) {
    return (
      <p className="mt-1 text-sm text-muted-foreground">
        You&rsquo;re not following any instruments yet. Open a report and tap <b>Follow</b> to get a push notification when a new edition publishes for that instrument.
      </p>
    );
  }
