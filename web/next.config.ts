...
const csp = [
  ...
  "img-src 'self' data: blob: https://img.clerk.com https://*.clerk.com https://*.assetframe.co.uk https://*.r2.cloudflarestorage.com https://www.googletagmanager.com https://www.google-analytics.com",
  "font-src 'self' data:",
  ...
  "frame-src 'self' https://*.clerk.accounts.dev https://*.clerk.com https://*.assetframe.co.uk https://challenges.cloudflare.com",
