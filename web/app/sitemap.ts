...
export default async function sitemap(): Promise<MetadataRoute.Sitemap> {
  ...
  const now = new Date();
  const staticRoutes = ["", "/reports", "/track-record", "/pricing", "/how-it-works", "/faq", "/about", "/contact", "/feedback", "/terms", "/privacy", "/accessibility", "/reviews", "/developers", "/developers/mcp", "/developers/api"].map(
