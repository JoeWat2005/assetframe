...
const E: Filterable[] = [
  { instrument: "Ethereum / USD", ticker: "ETH-USD", assetClass: "Cryptocurrency (aggregate spot)", bias: "Bearish-lean", status: "Wait" },
  { instrument: "Solana / USD", ticker: "SOL-USD", assetClass: "Cryptocurrency (aggregate spot)", bias: "Constructive-lean", status: "Wait" },
  { instrument: "Apple Inc.", ticker: "AAPL", assetClass: "US single stock (Nasdaq)", bias: "Neutral", status: "Wait" },
];
